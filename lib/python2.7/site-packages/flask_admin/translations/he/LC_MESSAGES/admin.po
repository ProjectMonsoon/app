...
msgstr "קובץ \"%(name)s\" נמחק בהצלחה."
...
msgstr "שגיאה לא צפויה במהלך הקריאה מתוך %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:1036
#, python-format
msgid "Cannot edit %(name)s."
msgstr "לא ניתן לערוך %(name)s."
...
msgstr "יצירת רשומה נכשלה. %(error)s"
...
msgstr "לא ניתן למחוק רשומה. %(error)s"
...
msgstr "האם אתה בטוח שברצונך למחוק את הרשומות שנבחרו?"
...
msgstr[0] "שיא נמחק בהצלחה."
msgstr[1] "%(count)s רשומות נמחקו בהצלחה."
...
msgstr "שגיאה שלמות. %(message)s"

#: ../flask_admin/form/fields.py:96
msgid "Invalid time format"
msgstr "תבנית השעה לא חוקי"

#: ../flask_admin/form/fields.py:142
msgid "Invalid Choice: could not coerce"
msgstr "בחירה לא חוקית: לא יכול לאלץ"
