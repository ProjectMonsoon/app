...
msgstr "ファイル「%(name)s」が正常に削除されました。"
...
msgstr[0] "%(count)s レコードが正常に削除されました。"
...
msgstr "少なくとも 1 つのファイルを選択してください。"
