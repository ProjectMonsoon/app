...
msgstr "CLI: Недопустимая команда."
...
msgstr "Каталог успешно создан: %(directory)s"
...
msgstr "Каталог «%(path)s» был успешно удален."
...
msgstr "Переименование отключено."
...
msgstr "Непредвиденная ошибка при чтении из %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:1036
#, python-format
msgid "Cannot edit %(name)s."
msgstr "Не удается изменить %(name)s."
...
msgstr "Удаление файлов отключено."
...
msgstr "Не удалось получить модель. %(error)s"
...
msgstr[0] "Запись успешно удалена."
msgstr[1] "Было удалено %(count)s записей."
...
msgstr "Не удалось удалить записи. %(error)s"
...
msgstr[0] "По крайней мере %(num)d элемент требуется"
msgstr[1] "По крайней мере %(num)d элемента требуется"
msgstr[2] "По крайней мере %(num)d элементов требуется"

#: ../flask_admin/contrib/sqla/view.py:996
#, python-format
msgid "Integrity error. %(message)s"
msgstr "Ошибка целостности. %(message)s"
...
msgstr "Нет элементов в таблице."

#: ../flask_admin/model/base.py:1620
#, python-format
msgid "Invalid Filter Value: %(value)s"
msgstr "Недопустимое значение фильтра: %(value)s"
...
msgstr "Сохранить и добавить новый объект"
