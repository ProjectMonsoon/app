...
msgstr "Arquivo salvo com êxito: %(name)s"
...
msgstr "Diretório criado com sucesso: %(directory)s"
...
msgstr "Não é possível operar em diretórios não-vazios"
...
msgstr[0] "Registro foi excluído com êxito."
msgstr[1] "%(count)s registros foram excluídos com êxito."
...
msgstr "Valor de filtro inválido: %(value)s"
...
msgstr "Depedência Tablib não instalada."

#: ../flask_admin/model/base.py:2178
#, python-format
msgid "Export type \"%(type)s not supported."
msgstr "Tipo de exportação \"%(type)s não é suportado."
