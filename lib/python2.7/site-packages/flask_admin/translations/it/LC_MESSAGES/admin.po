...
msgstr "Il file \"%(name)s\" esiste giá."
...
msgstr "Il file \"%(name)s\" é stato eliminato correttamente."
...
msgstr "Impossibile eliminare il file: %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:942
msgid "Renaming is disabled."
msgstr "La rinominazione é disabilitata."
...
msgstr "Errore imprevisto durante la lettura di %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:1036
#, python-format
msgid "Cannot edit %(name)s."
msgstr "Non è possibile modificare %(name)s."
...
msgstr "La cancellazione del file è disattivata."
...
msgstr "Non può funzionare in directory non vuote"
...
msgstr "Impossibile ottenere il modello. %(error)s"
...
msgstr "Impossibile creare il record. %(error)s"
...
msgstr "Impossibile aggiornare il record. %(error)s"
...
msgstr "Impossibile eliminare il record: %(error)s"
...
msgstr[0] "Il record é stato eliminato con successo."
msgstr[1] "%(count)s records eliminati con successo."
...
msgstr "Impossibile eliminare le righe: %(error)s"
...
msgstr[0] "È necessario almeno %(num)d elemento"
msgstr[1] "Sono necessari almeno %(num)d elementi"

#: ../flask_admin/contrib/sqla/view.py:996
#, python-format
msgid "Integrity error. %(message)s"
msgstr "Errore di integrità. %(message)s"
...
msgstr "Scelta non valida: impossibile forzare"
...
msgstr "Selezionare almeno un record."
