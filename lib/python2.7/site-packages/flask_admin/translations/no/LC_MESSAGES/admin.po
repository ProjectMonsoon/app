...
msgstr "Fil for opplasting"

#: ../flask_admin/contrib/fileadmin/__init__.py:338
msgid "File required."
msgstr "Fil er nødvendig."
...
msgstr "Filen \"%(name)s\" finnes allerede."
...
msgstr "Filen \"%(name)s\" ble slettet."
...
msgstr "Uventet feil under lesing fra %(name)s"
...
msgstr "Sletting av filer er deaktivert."
...
msgstr "Kan ikke hente modell. %(error)s"
...
msgstr "Kan ikke opprette posten. %(error)s"
...
msgstr "Kan ikke slette posten. %(error)s"
...
msgstr[0] "Posten ble slettet."
msgstr[1] "%(count)s poster ble slettet."
...
msgstr "Kan ikke slette posten(e). %(error)s"
...
msgstr "Integritets feil. %(message)s"
...
msgstr "Ugyldig valg: kan ikke tvinge"
