...
msgstr "Pomyślnie usunięto plik \"%(name)s\"."
...
msgstr "Wystąpił nieoczekiwany błąd podczas odczytu z %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:1036
#, python-format
msgid "Cannot edit %(name)s."
msgstr "Nie można edytować %(name)s."
...
msgstr "Usuwanie pliku jest wyłączone."
...
msgstr "Nie udało się uzyskać modelu. %(error)s"
...
msgstr "Nie udało się utworzyć rekordu. %(error)s"
...
msgstr "Nie udało się zaktualizować rekordu. %(error)s"
...
msgstr "Nie można usunąć rekordu. %(error)s"
...
msgstr "Czy na pewno chcesz usunąć zaznaczone rekordy?"
...
msgstr[0] "Rekord został pomyślnie usunięty."
msgstr[1] "%(count)s rekordy zostały pomyślnie usunięte."
msgstr[2] "%(count)s rekordy zostały pomyślnie usunięte."
...
msgstr "Nie można usunąć rekordów. %(error)s"
...
msgstr[0] "Przynajmniej %(num)d element jest wymagany"
msgstr[1] "Przynajmniej %(num)d elementy są wymagane"
msgstr[2] "Przynajmniej %(num)d elementów jest wymaganych"

#: ../flask_admin/contrib/sqla/view.py:996
#, python-format
msgid "Integrity error. %(message)s"
msgstr "Błąd integralności. %(message)s"
...
msgstr "Nieprawidłowy wybór: nie można zmusić"
...
msgstr "Wybierz co najmniej jeden plik."
...
msgstr "Zaznacz wszystkie rekordy"
...
msgstr "Wybierz co najmniej jeden rekord."
