...
msgstr "Úspěšně uložený soubor: %(name)s"
...
msgstr "Úspěšně vytvořen adresář: %(directory)s"
...
msgstr "Adresář \"%(path)s\" byla úspěšně odstraněna."
...
msgstr "Neočekávaná chyba při čtení z %(name)s"

#: ../flask_admin/contrib/fileadmin/__init__.py:1036
#, python-format
msgid "Cannot edit %(name)s."
msgstr "Nelze upravovat %(name)s."
...
msgstr "Odstranění souborů je zakázáno."
...
msgstr "Nepodařilo se získat modelu. %(error)s"
...
msgstr "Neplatná volba: nebylo převedeno"
...
msgstr "V tabulce nejsou žádné položky."

#: ../flask_admin/model/base.py:1620
#, python-format
msgid "Invalid Filter Value: %(value)s"
msgstr "Neplatná hodnota filtru: %(value)s"
